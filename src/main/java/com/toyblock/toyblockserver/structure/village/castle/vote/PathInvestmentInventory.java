...
public class PathInvestmentInventory implements Listener {
    ...
    public void start_createInv (UUID UUID) {
        ...
        int coin = com.toyblock.toyblockserver.structure.village.castle.vote.PathInvestment.InvestmentInv.get(UUID);
        int full = (coin/64);
        int etc = coin&64;
        if(coin <= 64) {
    ...
    public void createInv (UUID UUID ,Location loc ,int goal) {
        com.toyblock.toyblockserver.structure.village.castle.vote.VoteItem item = new com.toyblock.toyblockserver.structure.village.castle.vote.VoteItem();
        Inventory inv = Bukkit.createInventory(null,54);
   ...
   //     inv.setItem(41,item.investment_put_null());
        ...
        com.toyblock.toyblockserver.structure.village.castle.vote.PathInvestment.Inv.put(UUID,inv); //인벤등록
        com.toyblock.toyblockserver.structure.village.castle.vote.PathInvestment.Inv_amount.put(inv,goal); //투자금 등록
        com.toyblock.toyblockserver.structure.village.castle.vote.PathInvestment.InvestmentLink.put(loc,inv);
        com.toyblock.toyblockserver.structure.village.castle.vote.PathInvestment.InvestmentGorundLink.put(UUID,loc);
        com.toyblock.toyblockserver.structure.village.castle.vote.PathInvestment.InvestmentUUIDLink.put(inv,UUID);
    }
    ...
    public boolean setInvestmentGoal (Inventory inv, int goal) {
        ...
        com.toyblock.toyblockserver.structure.village.castle.vote.VoteItem item = new VoteItem();
